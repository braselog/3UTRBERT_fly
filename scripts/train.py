...
def train(args, train_dataset, model, tokenizer):
    ...
    for _ in train_iterator:
        ...
        if args.output_mode == "classification":
            ...
            results = compute_metrics(args.task_name, preds, out_label_ids, probs)
        else:
...
# %%
    ...
    parser.add_argument("--data_dir", default='output/data/RBP/CG3800', type=str, help="The input data dir. Should contain the .tsv files (or other data files) for the task.",)
    ...
    parser.add_argument("--model_name_or_path", default="output/flyTrained", type=str, help="Path to pre-trained model or shortcut name selected in the list",)
